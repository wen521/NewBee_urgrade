...
public class NewBeeMallGoodsCategoryController {
    ...
    public String categoriesPage(HttpServletRequest request, @RequestParam("categoryLevel") Byte categoryLevel, @RequestParam("parentId") Long parentId, @RequestParam("backParentId") Long backParentId) {
        ...
        request.getSession().setAttribute("path", "newbee_mall_category");
        request.getSession().setAttribute("parentId", parentId);
        request.getSession().setAttribute("backParentId", backParentId);
        request.getSession().setAttribute("categoryLevel", categoryLevel);
