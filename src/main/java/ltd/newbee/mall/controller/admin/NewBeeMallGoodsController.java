...
public class NewBeeMallGoodsController {
    ...
    public String goodsPage(HttpServletRequest request) {
        request.getSession().setAttribute("path", "newbee_mall_goods");
        return "admin/newbee_mall_goods";
    }

    @GetMapping("/goods/edit")
    public String edit(HttpServletRequest request) {
        request.getSession().setAttribute("path", "edit");
        //查询所有的一级分类
        ...
        if (!CollectionUtils.isEmpty(firstLevelCategories)) {
            ...
            if (!CollectionUtils.isEmpty(secondLevelCategories)) {
                ...
                request.getSession().setAttribute("firstLevelCategories", firstLevelCategories);
                request.getSession().setAttribute("secondLevelCategories", secondLevelCategories);
                request.getSession().setAttribute("thirdLevelCategories", thirdLevelCategories);
                request.getSession().setAttribute("path", "goods-edit");
    ...
    public String edit(HttpServletRequest request, @PathVariable("goodsId") Long goodsId) {
                ...
                if (currentGoodsCategory != null && currentGoodsCategory.getCategoryLevel() == NewBeeMallCategoryLevelEnum.LEVEL_THREE.getLevel()) {
                    ...
                    if (secondCategory != null) {
                        ...
                        if (firestCategory != null) {
                            ...
                            request.getSession().setAttribute("secondLevelCategories", secondLevelCategories);
                            request.getSession().setAttribute("thirdLevelCategories", thirdLevelCategories);
                            request.getSession().setAttribute("firstLevelCategoryId", firestCategory.getCategoryId());
                            request.getSession().setAttribute("secondLevelCategoryId", secondCategory.getCategoryId());
                            request.getSession().setAttribute("thirdLevelCategoryId", currentGoodsCategory.getCategoryId());
                        }
                    }
                }
            }
        ...
        request.getSession().setAttribute("goods", newBeeMallGoods);
        request.getSession().setAttribute("path", "goods-edit");
        return "admin/newbee_mall_goods_edit";
    }
