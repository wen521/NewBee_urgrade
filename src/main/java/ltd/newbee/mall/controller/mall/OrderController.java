...
public class OrderController {
    ...
    public String orderDetailPage(HttpServletRequest request, @PathVariable("orderNo") String orderNo, HttpSession httpSession) {
        ...
        request.getSession().setAttribute("orderDetailVO", orderDetailVO);
    ...
    public String orderListPage(@RequestParam Map<String, Object> params, HttpServletRequest request, HttpSession httpSession) {
        ...
        request.getSession().setAttribute("orderPageResult", newBeeMallOrderService.getMyOrders(pageUtil));
        request.getSession().setAttribute("path", "orders");
    ...
    public String selectPayType(HttpServletRequest request, @RequestParam("orderNo") String orderNo, HttpSession httpSession) {
        ...
        request.getSession().setAttribute("totalPrice", newBeeMallOrder.getTotalPrice());
